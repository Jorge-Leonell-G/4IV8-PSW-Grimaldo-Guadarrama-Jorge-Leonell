...
public class MUsuario {
    ...
    */
    ...
    private int id_usuario, id_formapago, privilegio_usuario;
    private String nombre_usuario, appat_usuario, apmat_usuario, dir_usuario;
    ...
    public MUsuario verificarUsuario(String user, String pass){
        ...
        try{
            ...
            while(rs.next()){
                ...
                u.setDir_usuario(rs.getString("dir_usuario"));
