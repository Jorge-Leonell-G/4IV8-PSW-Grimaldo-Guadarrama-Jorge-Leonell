<%-- 
    ...
    Created on : 2/05/2021, 09:00:56 PM
    Author     : rash2
--%>
    ...
    <body>
        ...
        try{
            ...
            try{
                    ...
                    q = "delete from Cproducto where id_hel="+id;
                    
                    
                    int eliminar = set.executeUpdate(q);
                    
                    %>
                    <h1>Producto Eliminado con Éxito</h1>
                    <%
                        set.close();
                            
            }catch(SQLException ed){
                System.out.println("Error al elimnar el producto en la tabla");
