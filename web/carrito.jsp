<%-- 
    Document   : carrito
    Created on : 10/06/2021, 10:32:41 PM
    Author     : leone
--%>
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                      <a class="nav-link" href="Controlador?accion=index.jsp">Seguir Comprando</a>
                  </li>
                </ul>
                <form class="d-flex">
                         ...
                         <div class="col-sm-4" >
                             <div class="card" >
                                 ...
                                 <div class="card-footer" >
                                     <a href="FinalizarCompra" class="btn btn-outline-info btn-block" >Realizar Pago</a>
